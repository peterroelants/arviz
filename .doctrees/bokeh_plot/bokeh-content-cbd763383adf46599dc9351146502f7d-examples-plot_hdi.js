(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("f948ddad-2f29-45f9-b00e-b80e2ea4833e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f948ddad-2f29-45f9-b00e-b80e2ea4833e' but no matching script tag was found.")
        }
